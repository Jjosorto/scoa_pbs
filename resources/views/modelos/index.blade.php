            ...
            <table id="table" class="display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $modelo->categoria->nombreCategoria }}</td>
                        <td>@if($modelo->estadoModelo == 0)
                            Inactivo
                            @else
                            Activo
                            @endif
                        ...
                        <td style="text-align: end">
                            <a href="{{ route('modelos.edit', $modelo->id) }}"><button class="btn btn-dark"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></button></a>
                            <button class="btn btn-secondary btn-desactivar" data-id="{{ $modelo->id }}"><i class="fas fa-ban" style="color: #ffffff;"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
