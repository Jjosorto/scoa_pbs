                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: end">
                            <a href="{{ route('departamentos.edit', $departamento->id) }}"><button class="btn btn-dark"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></button></a>
                            <button class="btn btn-secondary btn-desactivar" data-id="{{ $departamento->id }}"><i class="fas fa-ban" style="color: #ffffff;"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            $('#table').on('click', '.btn-desactivar', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ route('departamentos.desactive', ':id') }}";
