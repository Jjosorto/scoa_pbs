        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="{{ asset('assetss/img/logo.png') }}" alt="Pbs-Logo" class="" height="50px" width="50px">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link style="text-decoration: none" :href="route('activos.index')" :active="request()->routeIs('activos.*')">
                        Activos
                    </x-nav-link>
